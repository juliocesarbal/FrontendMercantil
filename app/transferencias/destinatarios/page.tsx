...
export default function GestionarDestinatariosPage() {
    ...
    <div className="min-h-screen bg-[#e8ebe8] flex flex-col">
      ...
      <div className="bg-[#1a5235] text-white px-4 pt-12 pb-4">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-lg font-medium">Gestionar destinatarios</h1>
        </div>
      ...
      <div className="flex-1 flex items-start justify-center pt-8">
        <p className="text-gray-600">No se han encontrado cuentas.</p>
      </div>
    </div>
  )
}
